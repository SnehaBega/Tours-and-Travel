...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/tour&travel/user/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
$mail->Port = 587; 
$mail->Username = "begasneha@gmail.com";   //Enter your username/emailid
$mail->Password = "Suga@AgustD07";   //Enter your password
$mail->FromName = "Travel_Render";
